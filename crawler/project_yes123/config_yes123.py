...
JOB_LISTING_BASE_URL_YES123 = config_section.get("JOB_LISTING_BASE_URL_YES123", "https://www.yes123.com.tw/wk_index/joblist.asp")
...
URL_CRAWLER_PAGE_SIZE_YES123 = int(config_section.get("URL_CRAWLER_PAGE_SIZE_YES123", "30"))  # 每頁的工作數量
