from crawler.project_cakeresume.task_category_cakeresume import fetch_url_data_cakeresume
import structlog
...
fetch_url_data_cakeresume.s(JOB_CAT_URL_CAKERESUME).apply_async(queue='producer_category_cakeresume')
